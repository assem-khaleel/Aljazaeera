  ...
  <div id="content" class="container">
    ...
    <div class="inner-content-container contact">
      ...
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 for-small required">
          <div class="full-width relative">
            <label  for="input-firstname"><?php echo $entry_firstname; ?></label>
            <input type="text"  name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>" id="input-firstname"  class="common_input">
        ...
        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 for-small required">
          <div class="full-width relative">
            ...
            <input type="text"  name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>" id="input-lastname"  class="common_input">
...
(
     ...
     "93"=>"+93",
              ...
              <input  type="tel" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone" class="common_input">
            </div><!-- /.d_flex -->
          </div><!-- /.full-width -->
        ...
        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 for-small required">
          <div class="full-width relative">
            ...
            <input type="password"  name="confirm" value="<?php echo $confirm; ?>" placeholder="<?php echo $entry_confirm; ?>" id="input-confirm"  class="common_input">
        ...
        <div class="col-lg-12 col-md-12 col-s-12 col-xs-12 terms">


          <?php if ($text_agree) { ?>


          <label><?php echo $terms_conditions; ?></label>

          <?php if ($agree) { ?>
          <input type="checkbox"  id="ckr"name="agree" value="1" checked="checked" />
          <?php } else { ?>
          <input type="checkbox" id="ckr" name="agree" value="1" />
          <?php } ?>
          <label class="ck" for="ckr"><?php echo $text_agree; ?></label>
      ...
      <div class="full-width text-center mtp">

        <button type="submit" value="<?php echo $button_continue; ?>" class="reg_btn" /><?php echo $button_continue; ?></button>
