            ...
            <div class="side-nav-wrapper">
              <div class="side-nav">
                <ul>
                  ...
                  <li><a href="<?php echo $editLink;?>">account information</a></li>
                  <li><a href="<?php echo $addressLink;?>" class="active">address book</a></li>
                  <li><a href="<?php echo $orderLink;?>">your orders</a></li>
                  <li><a href="<?php echo $passwordLink;?>">change password</a></li>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3">
                      <div class="checkbox-container">
                        <input type="checkbox"   name="default" value="1"   <?php if ($default) { ?> checked <?php } ?> >
                        <label><?php echo $entry_default; ?></label>
                      </div>
                    </div>
                    <div class="col-md-6 pull-right">

                      <button  type="submit" class="reg_btn">add new address </button>
                    </div>
