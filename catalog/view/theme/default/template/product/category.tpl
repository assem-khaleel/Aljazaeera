  ...
  <div class="product-list"><!--Product List-->
    <div class="container"><!--container-->
      ...
      <div class="row">
        ...
        <?php $i=0; foreach ($products as $product) {if($i%4 ==0){echo'<div style="clear:both;"></div>';}  $i++; ?>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6"><!--col-md-3-->
          <div class="item fixed-height"><!--item-->
            ...
            <div class="hover"><a href="<?php echo $product['href']; ?>"><img src="image/catalog/quick-view-img.png" alt="">
           <?php echo $quick_view; ?> </a></div>
          </div><!--item-->
        </div><!--col-md-3-->
        <?php } ?>
