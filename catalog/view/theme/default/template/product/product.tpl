...
<section class="inner-banner"><!--Inner banner-->
  ...
  <div class="container">
    <h2><?php echo $product_details_text; ?></h2>
  </div>
...
<section class="inner-content-wrapper" id="product"><!--Inner Content section-->
  <div class="container">
            ...
            <div class="product-right">
              ...
              <h4>
                ...
                <?php if ($price) { ?>
                  ...
                  <?php if (!$special) { ?>
                <?php echo $price_text; ?> <span class="price"><?php echo $price; ?></span>

                <?php } else { ?>



                <?php echo $price_text; ?> <span class="price"><?php echo $special; ?></span>  <span class="old-price">
                 <?php echo $price; ?></span>
                  <?php } ?>
              ...
              <h5> <?php echo $text_stock; ?><span> <?php echo $stock; ?> </span> </h5>
              ...
              <div class="quantity">
                <label><?php echo $quantity_text; ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  -</label>
                <select  name="quantity" value="<?php echo $minimum; ?>" id="input-quantity" >
                  <?php for($i=$minimum;$i<$minimum+10;$i++) { ?>
              ...
              <div class="product-btns">
                <div class="row">
                  <div class="col-md-6">
                    <a  title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');">
                      <img src="image/catalog/add-wish-img.jpg">
                  ...
                  <div class="col-md-6">
                    ...
                    <a  id="button-cart" data-loading-text="<?php echo $text_loading; ?>">
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="product-description-box">
                <h4><?php echo $product_description_text; ?></h4>
                <p>
                  <?php echo $description; ?>
                </p>
              </div>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          <?php if ($thumb || $image/catalog) { ?>
          <ul class="thumbnails">
            <?php if ($thumb) { ?>
            <li><a class="thumbnail" href="<?php echo $popup; ?>" title="<?php echo $heading_title; ?>"><img src="<?php echo $thumb; ?>" title="<?php echo $heading_title; ?>" alt="<?php echo $heading_title; ?>" /></a></li>
            <?php } ?>
            <?php if ($image/catalog) { ?>
            <?php foreach ($image/catalog as $image) { ?>
