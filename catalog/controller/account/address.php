...
class ControllerAccountAddress extends Controller {
	...
	public function delete() {
		...
		$addresses_id=($this->request->get['address_id'] && is_array($this->request->get['address_id']))? $this->request->get['address_id']:array($this->request->get['address_id']);

		foreach($addresses_id as $address_id){
		if ($this->validateDelete($address_id)) {
	...
	protected function getList() {
        ...
        $data['user_dashboard'] = $this->language->get('user_dashboard');
        $data['account_information'] = $this->language->get('account_information');
        ...
        $data['edit_info'] = $this->language->get('edit_info');
        $data['delivery_address'] = $this->language->get('delivery_address');
        $data['select_check'] = $this->language->get('select_check');
        $data['deleted_selected'] = $this->language->get('deleted_selected');
		...
		foreach ($results as $result) {
			...
			$data['addresses'][] = array(
				...
				'editAction'=>$this->url->link('account/address/edit', 'address_id=' . $result['address_id'], true),
		...
		$data['passwordLink']=$this->url->link('account/password', '', true);
		$data['orderLink']=$this->url->link('account/order', '', true);
		$data['editLink']=$this->url->link('account/edit', '', true);
		$data['addressLink']=$this->url->link('account/address', '', true);
